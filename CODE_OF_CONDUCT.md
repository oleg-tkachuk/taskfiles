...
issues, pull requests, discussions — and applies when an individual is
officially representing the project in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported through GitHub's private vulnerability reporting form at
[/security/advisories/new](https://github.com/oleg-tkachuk/taskfiles/security/advisories/new),
which reaches the maintainer directly and privately even though the name says
"vulnerability" — there is no other private channel for this project. All
